...
def test_get_items(fake_uow):
    results = services.get_items(10, 0, None, None, uow=fake_uow)
...
def test_delete_item(fake_uow):
    expected_length = len(services.get_items(10, 0, None, None, uow=fake_uow)) - 1
    delete_record = services.get_item(2, fake_uow)
    services.delete_item(2, fake_uow)
    result = services.get_items(10, 0, None, None, uow=fake_uow)
